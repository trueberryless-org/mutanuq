---
title: USART - Universal Synchronous and Asynchronous Receiver Transmitter
sidebar:
  label: USART
---
...
Um die Implementierung zu erleichtern, verwendet man [Pointer](/de/embedded-programming/pointer). Dies ist die Methode für einzelne [ASCII-Zeichen](https://www.torsten-horn.de/techdocs/ascii.htm).
